...
p3 = plt.bar([0.1,1.1],data.loc['Livestock'],0.8,bottom=data.loc['Wild mammals'],color='#b04e2d')
p2 = plt.bar([0.1,1.1],data.loc['Humans'],0.8,bottom=data.loc['Wild mammals']+data.loc['Livestock'],color='#4250ff')
p1 = plt.bar([0.1,1.1],data.loc['Wild mammals'],0.8,color='#ff282d')




plt.xticks([0.1,1.1], ('100,000 BP', 'present'),fontsize=40)
plt.legend((p2[0], p3[0],p1[0]), ('Humans', 'Livestock','Wild mammals'),loc='upper left')
ax.set_ylabel('Biomass (Gt C)',fontsize=40)
